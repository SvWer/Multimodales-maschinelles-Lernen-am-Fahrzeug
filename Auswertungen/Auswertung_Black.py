...
json_path = dataSet_path + 'SSD_Detections/dataMaskBlack.json'
#jsonMask_path = dataSet_path + 'SSD_Detections/dataMask.json'
#jsonAfterMask_path = dataSet_path + 'SSD_Detections/dataAfterMask.json'
#jsonAfterMask_path = dataSet_path + 'SSD_Detections/dataOwn.json'
main_path = "main_img/"
...
if __name__ == "__main__":
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig(dataSet_path+'SSD_beforeBlack_graphen.png')
    plt.close()
    ...
    plt.savefig(dataSet_path+"SSD_beforeBlack_table.png")
    plt.close()
