...
json_path = dataSet_path + 'SSD_Detections/dataMaskWhite.json'
main_path = "main_img/"
...
if __name__ == "__main__":
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig(dataSet_path+'SSD_beforeWhite_graphen.png')
    plt.close()
    ...
    plt.savefig(dataSet_path+"SSD_beforeWhite_table.png")
    plt.close()
