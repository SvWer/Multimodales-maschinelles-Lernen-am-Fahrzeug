...
def performSSDNormal(PATHS, output_path, json_dic, json_path):	 
...
'''
    Perfom SSD without Mask
'''
performSSDNormal(IMAGE_PATHS, SSD_PATH, json_obj, SSD_PATH+'data.json')
print("Object Detection with normal SSD was running for ",(time.time() - start_time),"seconds.")
start_time = time.time() 